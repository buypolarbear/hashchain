<?php
use multichain\MultichainClient;
use multichain\MultichainHelper;
...
class MultichainClientTest //extends \PHPUnit_Framework_TestCase
{
	...
	/**
	 * 	Returns general information about a block.
	 *
	 */
	public function GetBlock($hash)
	{
		return $this->multichain->setDebug(true)->getBlock($hash);
	}
	...
	*/
	...
	public function GetAddressTransaction($address, $txId){
	 ...
	 public function ListAddressTransactions($address){
		...
		//$assetInfo = $this->createTestAsset($address1);
		//$txId = $this->multichain->sendToAddress($address2, array($assetInfo["name"] => 100));
		return $this->multichain->setDebug(true)->listAddressTransactions($address);
	}
